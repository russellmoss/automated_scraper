-- ================================================================
-- COMPLETE MIGRATION: Move savvy_pirate to Toronto Region
-- ================================================================
-- This script migrates everything from US to Toronto region
-- Run this in BigQuery Console (any region - it will create in Toronto)
-- ================================================================
...
-- Copy other analysis tables (create with schema even if empty)
CREATE TABLE IF NOT EXISTS `savvy-gtm-analytics.savvy_pirate_toronto.weekly_analyses` 
LIKE `savvy-gtm-analytics.savvy_pirate.weekly_analyses`;

CREATE TABLE IF NOT EXISTS `savvy-gtm-analytics.savvy_pirate_toronto.new_advisor_reports` 
LIKE `savvy-gtm-analytics.savvy_pirate.new_advisor_reports`;

CREATE TABLE IF NOT EXISTS `savvy-gtm-analytics.savvy_pirate_toronto.advisor_movement_alerts` 
LIKE `savvy-gtm-analytics.savvy_pirate.advisor_movement_alerts`;

CREATE TABLE IF NOT EXISTS `savvy-gtm-analytics.savvy_pirate_toronto.crm_match_results` 
LIKE `savvy-gtm-analytics.savvy_pirate.crm_match_results`;

CREATE TABLE IF NOT EXISTS `savvy-gtm-analytics.savvy_pirate_toronto.advisor_job_changes` 
LIKE `savvy-gtm-analytics.savvy_pirate.advisor_job_changes`;
